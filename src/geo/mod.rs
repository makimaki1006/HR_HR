...
/// 都道府県コード → GeoJSONファイル名（ローマ字込み）
pub fn pref_code_to_geojson_filename(code: &str) -> String {
    let romaji = match code {
        "01" => "hokkaido",
        "02" => "aomori",
        "03" => "iwate",
        "04" => "miyagi",
        ...
        "46" => "kagoshima",
        "47" => "okinawa",
        _ => return format!("{}.json", code),
    };
    format!("{}_{}.json", code, romaji)
}
