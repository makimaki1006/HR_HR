//! 分割: render/subtab5_anomaly.rs (物理移動・内容変更なし)
...
pub(super) fn render_anomaly_section(data: &[Row]) -> String {
...
pub(super) fn render_minimum_wage_section(data: &[Row], pref: &str) -> String {
...
pub(super) fn render_wage_compliance_section(data: &[Row]) -> String {
    let mut html = String::with_capacity(4_000);
    html.push_str(r#"<div class="stat-card">
...
pub(super) fn render_job_openings_ratio_section(data: &[Row], pref: &str) -> String {
    // データを全国と都道府県に分離
...
pub(super) fn render_labor_stats_section(data: &[Row], pref: &str) -> String {
...
pub(super) fn render_prefecture_stats_section(data: &[Row], pref: &str) -> String {
...
pub(super) fn render_population_section(pop_data: &[Row], pyramid: &[Row]) -> String {
...
pub(super) fn render_demographics_section(migration: &[Row], daytime: &[Row]) -> String {
    let mut html = String::with_capacity(4_000);
    html.push_str(r#"<div class="stat-card">
...
pub(super) fn render_establishment_section(data: &[Row], pref: &str) -> String {
    if data.is_empty() {
        return String::new();
    }
...
pub(super) fn render_turnover_section(data: &[Row], pref: &str) -> String {
    // データを全国と都道府県に分離
...
pub(super) fn render_household_spending_section(data: &[Row], pref: &str) -> String {
    if data.is_empty() {
        return String::new();
    }
...
pub(super) fn render_business_dynamics_section(data: &[Row], pref: &str) -> String {
    if data.is_empty() {
        return String::new();
    }
...
pub(super) fn render_climate_section(data: &[Row], pref: &str) -> String {
    if data.is_empty() {
        return String::new();
    }
...
pub(super) fn render_care_demand_section(data: &[Row], pref: &str) -> String {
    if data.is_empty() {
        return String::new();
    }
...
pub(super) fn render_education_section(data: &[Row], pref: &str) -> String {
    if data.is_empty() {
        return String::new();
    }
    let pref_label = if pref.is_empty() { "全国" } else { pref };
...
pub(super) fn render_household_type_section(data: &[Row], pref: &str) -> String {
    if data.is_empty() {
        return String::new();
    }
    let pref_label = if pref.is_empty() { "全国" } else { pref };
...
pub(super) fn render_foreign_residents_section(data: &[Row], pref: &str) -> String {
    if data.is_empty() {
        return String::new();
    }
    let pref_label = if pref.is_empty() { "全国" } else { pref };
...
pub(super) fn render_land_price_section(data: &[Row], pref: &str) -> String {
    if data.is_empty() {
        return String::new();
    }
    let pref_label = if pref.is_empty() { "全国" } else { pref };
...
pub(super) fn render_social_life_section(data: &[Row], pref: &str) -> String {
    if data.is_empty() {
        return String::new();
    }
    let pref_label = if pref.is_empty() { "全国" } else { pref };
...
pub(super) fn render_boj_tankan_section(data: &[Row]) -> String {
    if data.is_empty() {
        return String::new();
    }
...
pub(super) fn render_region_benchmark_section(data: &[Row]) -> String {
    let mut html = String::with_capacity(8_000);
    html.push_str(r#"<div class="stat-card">
