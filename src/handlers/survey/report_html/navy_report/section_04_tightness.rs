...
pub(crate) fn render_navy_section_04_market_tightness(
    ...
    // 2026-07-13 HW リーク撤去: 「求人媒体掲載数」= ctx.hw_industry_counts は
    //   FROM postings 由来 (HW データ)。顧客向け variant (MarketIntelligence /
    //   Extended / Sp) には出さず、Full (HW 併載版) 限定にする。非 Full では見出し
