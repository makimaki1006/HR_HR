...
use super::super::aggregator::{EmpTypeSalary, JobBoxRecord, SurveyAggregation};
...
// ============================================================================
// 2026-06-24 Section 07.5: 求人ボックス 年間休日 × 給与 詳細
//
// 設計意図 (ユーザー要望 2026-06-24):
...
//         `ApiHandler.js:annualHolidaysData` セクション + V2 独自の個別求人一覧。
//
// 適用条件:
...
pub(super) fn render_navy_section_jobbox_detail(html: &mut String, agg: &SurveyAggregation) {
...
#[cfg(test)]
mod jobbox_detail_section_tests {
    use super::*;
    ...
    fn median_helper_basic() {
        ...
        assert_eq!(compute_median_i64(&[1, 2, 3, 4]), 2); // (2+3)/2 = 2 (integer division)
